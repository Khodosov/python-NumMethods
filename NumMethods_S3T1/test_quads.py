...
from NumMethods_S3T1.integration import quad, quad_gauss, moments
...
# test_interpolation(np.cos)
# test_interpolation(np.sin)
# test_interpolation(np.exp)
# test_interpolation(np.sqrt)

# test_quad_degree()

# test_weighted_quad_degree()

# test_quad_gauss_degree()
